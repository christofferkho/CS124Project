 ...
 * @author Kiela
 */
public class setup extends MainUI {
    ...
    private void initComponents() {
        ...
        listTerminals = new javax.swing.JList();
        ...
        listTerminals.setBorder(javax.swing.BorderFactory.createEmptyBorder(10, 10, 10, 10));
        listTerminals.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        listTerminals.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        listTerminals.setMaximumSize(new java.awt.Dimension(365, 120));
        listTerminals.setMinimumSize(new java.awt.Dimension(53, 90));
        listTerminals.setPreferredSize(new java.awt.Dimension(365, 120));
        listTerminals.setSelectionBackground(new java.awt.Color(153, 153, 153));
        jScrollPane1.setViewportView(listTerminals);
    ...
    private javax.swing.JList listTerminals;
